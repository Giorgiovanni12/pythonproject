...
class Application(tk.Tk):
    def __init__(self):
        ...
        # Create the first button to transcribe the selected audio file
...
def transcribe(self):
        input = "/home/giorgio/papa-massimo/Notepad+++/How-To-Stop-Mumbling-Use-This-Quick-Technique.wav"
